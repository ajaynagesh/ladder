...
from ladder_conv import LadderAE

from processData.fuel_converter_sst import SST2mod
...
if __name__ == "__main__":
    ...
    def add_train_params(parser, use_defaults):
        ...
        a("--unlabeled-samples", help="How many unsupervised samples are used",
          type=int, default=default(None), nargs='+')
        a("--dataset", type=str, default=default(['sst2']), nargs='+',
          choices=['mnist', 'cifar10', 'sst2'], help="Which dataset to use")
