...
from fuel_converter_conv import EMBOOT_CONV_CONLL
...
def setup_data(p, test_set=False):
    dataset_class, training_set_size = {
        ...
        'conll_conv':(EMBOOT_CONV_CONLL, 13900)
    }[p.dataset]
...
if __name__ == "__main__":
    ...
    def add_train_params(parser, use_defaults):
        ...
        a("--unlabeled-samples", help="How many unsupervised samples are used",
          type=int, default=default(None), nargs='+')
        a("--dataset", type=str, default=default(['conll_conv']), nargs='+',
          choices=['mnist', 'cifar10', 'conll', 'ontonotes', 'conll_conv'], help="Which dataset to use")
